...
# Функція знаходження найбільшого значення
...
# Функція знаходження найменшого значення
...
# Функція знаходження сумми значеннь
...
# Знаходження сумми значеннь
sum_values = sum_of_values(root)
print("Суммя значеннь у дереві:", sum_values)